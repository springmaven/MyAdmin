...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/biz/order/createOrder", "anon");
        filterChainDefinitionMap.put("/biz/order", "anon");
        filterChainDefinitionMap.put("/biz/order/callback", "anon");
